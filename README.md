...
# Todos
1. fix the bugs
2. figure out a way to implement a way to determine which stats should be optimized for each pokemon
3. figure out a way to tell what the pokemon is weak, strong, average, no effect based on which pokemon (use types)
...
* other evolution triggers found in evolution details
